...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _nameLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_iconBtn.frame) + 10, kMoreItemIconSize, kMoreItemH- kMoreItemIconSize)];
...
{
    return [[self alloc] initWithFrame:CGRectMake(0, [[UIScreen mainScreen] bounds].size.height-kMorePanelHeight, [[UIScreen mainScreen] bounds].size.width, kMorePanelHeight)];
}
...
{
    NSInteger maxLinesOfPage = 1;
    NSInteger maxColsOfPage = 5;
    
    NSInteger pages = (items.count / (maxLinesOfPage * maxColsOfPage));
