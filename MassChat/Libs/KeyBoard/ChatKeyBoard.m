...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _morePanel = [[MorePanel alloc] initWithFrame:CGRectMake(0, kChatKeyBoardHeight-kFacePanelHeight, kScreenWidth, kFacePanelHeight)];
...
{
 if (self.chatToolBar.moreFuncSelected)
    {
...
{
        [self chatToolBarSendText:self.chatToolBar.textView.text];
...
- (void)keyboardDown
{
    if (self.keyBoardStyle == KeyBoardStyleChat)
    {
        ...
        [self.chatToolBar.moreBtn setImage:[UIImage imageNamed:@"chatMore_btn"] forState:UIControlStateNormal];
}
